...
export default function AuthForm() {
  ...
  return (
    <main className="w-full h-screen flex justify-center items-center relative">
      {error && (
        <div className="absolute top-10 bg-red-500/80 text-white px-6 py-2 rounded-full z-50 shadow-xl backdrop-blur-md">
          {error}
        </div>
      )}

      {success && (
        <div className="absolute top-10 bg-green-500/80 text-white px-6 py-2 rounded-full z-50 shadow-xl backdrop-blur-md">
          {success}
        </div>
      )}
      ...
      {/* SIGN IN FORM */}
      <div
        className={`${toggleSign ? "hidden" : "bg-[#071f18]/90 backdrop-blur-xl flex flex-col items-center py-8 px-6 sm:px-10 rounded-[2rem] sm:rounded-[3rem] shadow-2xl border border-white/10 w-[90%] sm:w-auto"}`}
      >
        <img
          src="/images/logo.png"
          alt="Logo"
      ...
      {/* SIGN UP FORM */}
      <div
        className={`${toggleSign ? "bg-[#071f18]/90 backdrop-blur-xl flex flex-col items-center py-8 px-6 sm:px-10 rounded-[2rem] sm:rounded-[3rem] shadow-2xl border border-white/10 w-[90%] sm:w-auto" : "hidden"}`}
      >
        <img
          src="/images/logo.png"
          alt="Logo"
